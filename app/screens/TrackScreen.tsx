...
// Maps the DB status enum to its translation key. Logic keys off the stable
// English enum value, never the translated label (CLAUDE.md gotcha #2).
          ...
          {justSubmitted && initialId && (
            ...
            >
              ...
              <div className="mt-2 flex items-center justify-between gap-2 rounded-xl bg-white/60 px-3 py-2">
                ...
                >
                  {copied ? t.trackCopied : t.trackCopy}
                </motion.button>
              </div>
            </motion.div>
          )}
        ...
        >
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1  rounded-sm border border-indigo/20 bg-white/70 p-3 text-ink outline-none transition focus:border-indigo"
            />
            <motion.button
              onClick={() => lookup(id)}
              ...
              className=" rounded-sm bg-marigold px-5 font-semibold text-indigo transition-opacity disabled:opacity-40"
            >
              {t.trackCheckBtn}
            </motion.button>
          </div>
          ...
          <AnimatePresence mode="wait">
            {state === "loading" && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
              >
                <Loader message={t.trackLookingUp} />
              </motion.div>
            )}
            ...
            {state === "found" && data && (
              <motion.div
                ...
                className="mt-6 overflow-hidden  rounded-sm border border-indigo/20 bg-white/70 p-5"
              >
                <motion.div
                  variants={foundItem}
                ...
                >
                  ...
                  >
                    {copied ? t.trackCopied : t.trackCopyId}
                  </motion.button>
                </motion.div>
                ...
                >
                  {t[STATUS_LABEL_KEYS[data.status] ?? ""] ?? data.status}
                </motion.p>
