...
export default function TrustPanel() {
  ...
  const points = [
    { id: "language", icon: <ChatIcon />, accent: "bg-marigold text-indigo", title: t.trust1Title, body: t.trust1Body },
    { id: "travel", icon: <HomeIcon />, accent: "bg-palm text-paper", title: t.trust2Title, body: t.trust2Body },
    { id: "judgment", icon: <HeartIcon />, accent: "bg-brick text-paper", title: t.trust3Title, body: t.trust3Body },
    { id: "anonymous", icon: <LockIcon />, accent: "bg-indigo text-paper", title: t.trust4Title, body: t.trust4Body },
    { id: "record", icon: <ReceiptIcon />, accent: "bg-marigold text-indigo", title: t.trust5Title, body: t.trust5Body },
  ];
